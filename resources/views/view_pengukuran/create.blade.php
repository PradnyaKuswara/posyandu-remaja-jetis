...
@section('title-page')
    Halaman Tambah Pengukuran
@endsection

@section('content')
    <div>
        <h1 class="sans text-xl text-extrabold">Tambah Pengukuran</h1>
    </div>
    <div class="mt-4">
        <div class="bg-white shadow-lg p-5">
            <form action="{{ url('dashboard/tambah-pengukuran-process') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid lg:grid-cols-2 mt-4 lg:mr-2 gap-4">
                    ...
                    <div class="md:col-span-2 mt-4 ">
                        ...
                        <textarea rows="100" type="text" name="deskripsi" aria-describedby="helper-text-explanation"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Deskripsi Pengukuran" autocomplete="off"></textarea>
                    </div>
                </div>
                <div class="mt-4 grid lg:grid-cols-2 gap-4">
                    <button type="submit"
                        class="border hover:opacity-75 lg:mr-2 text-white text-center rounded py-2 px-4 bg-blue-950  col-span-1">Tambah</button>
